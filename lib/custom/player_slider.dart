...
class PlayerSlider extends StatefulWidget {
  ...
  final PlayerIndicatorShape player;
...
class _RenderSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderSlider({
    ...
    required PlayerIndicatorShape player,
  ...
  PlayerIndicatorShape get player => const PlayerIndicatorShape();
  PlayerIndicatorShape _player;

  set player(PlayerIndicatorShape value) {
    if (value == _player) {
      return;
    }
    _player = value;
