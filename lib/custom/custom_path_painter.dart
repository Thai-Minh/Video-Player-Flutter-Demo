...
class CustomPathPainter {
  const CustomPathPainter();
  ...
  void paint(
    ...
    final double labelHalfWidth = labelImage != null ? labelImage.width.toDouble() : labelText.width / 2.0;
    ...
    if(labelImage != null) {
      canvas.drawImage(labelImage, Offset.zero - Offset(labelHalfWidth, labelImage.height / 2.0), paint);
    } else {
      labelText.paint(canvas,
          Offset.zero - Offset(labelHalfWidth, labelText.height / 2.0));
    }
